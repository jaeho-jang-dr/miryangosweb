...
import { validatePrescriptionDur, extractMedicationsFromRequests } from '@shared/lib/fhir/hira-bridge';
import { extractFromBundle } from '@shared/lib/fhir/bundle-builder';
import { HiraError } from '@shared/types/hira';
import type { FhirBundle, FhirMedicationRequest } from '@shared/types/fhir';
