...
import { exportPatientBundle } from '@shared/lib/fhir';

const FHIR_CONTENT_TYPE = 'application/fhir+json';

/**
 * GET /api/fhir/Patient/[id]/$everything — Export complete patient record
 */
export async function GET(
  ...
  try {
    ...
    console.error('[FHIR $everything] Error:', message);
