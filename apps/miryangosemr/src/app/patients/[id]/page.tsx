    ...
    if (!patient) {
        return (
            <div className="text-center py-12">
                ...
                <Link href="/patients" className="text-emerald-600 hover:underline mt-2 inline-block">
                    목록으로 돌아가기
                </Link>
            </div>
        );
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-4">
                    <Link href="/patients" className="p-2 hover:bg-slate-200 rounded-full transition-colors text-slate-500">
                ...
                <div className="flex gap-2">
                    <button
                        onClick={() => router.push(`/records/new?patientId=${patient.id}`)}
