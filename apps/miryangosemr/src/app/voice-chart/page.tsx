...
import type { TranscriptSegment } from '@shared/lib/voice/speech-recognition';
import type { RecordingState } from '@shared/lib/voice/audio-recorder';
...
function VoiceChartPageContent() {
    ...
    useEffect(() => {
        if (typeof window !== 'undefined') {
            import('@shared/lib/voice/speech-recognition').then(({ WebSpeechRecognition }) => {
                try {
        ...
        try {
            ...
            if (visitIdParam) {
                ...
                if (confirm('진료실로 돌아가시겠습니까?')) {
                    window.location.href = `/consulting/${visitIdParam}`;
                }
            } else {
                const chartData = {
                    ...chart,
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
                    <div className="flex items-start gap-5">
                        <Link
                            href={visitIdParam ? `/consulting/${visitIdParam}` : '/'}
                ...
                <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 items-start">
                    ...
                    <div className="xl:col-span-7 space-y-6">
                        ...
                        <div className="bg-indigo-50/50 rounded-2xl border border-indigo-100/50 p-6 flex gap-4">
                            <div className="text-2xl pt-1">TIP</div>
