    ...
    "inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
    {
        variants: {
            variant: {
                ...
                outline:
                    "border border-input bg-background shadow-sm hover:bg-apple-gray hover:text-accent-foreground",
                secondary:
                    "bg-apple-gray text-secondary-foreground shadow-sm hover:bg-apple-gray/80",
                ghost: "hover:bg-apple-gray hover:text-accent-foreground",
